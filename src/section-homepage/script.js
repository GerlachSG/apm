document.addEventListener("DOMContentLoaded", () => {
    ...
    const sliderContent = [
        { name: "Dia das Mulheres", img: "./assets/img1.png", link: "#mulheres" },
        { name: "Novo E-Commerce APPM", img: "./assets/img2.png", link: "#ecommerce" },
        { name: "Conscientização Setembro", img: "./assets/img3.png", link: "#setembro" },
        { name: "Dia do Autista", img: "./assets/img4.jpg", link: "#autista" },
        { name: "Gincana 2025", img: "./assets/img5.jpg", link: "#gincana" },
        { name: "Projetos para o Mundo", img: "./assets/img6.png", link: "#projetos" },
    ];
